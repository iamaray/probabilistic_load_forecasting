...
def save_checkpoint(state, is_best, epoch, checkpoint, ins_name=-1):
    ...
    if ins_name == -1:
        ...
        filepath = os.path.join(checkpoint, f'epoch_{
                                epoch}_ins_{ins_name}.pth.tar')
...
def final_metrics(raw_metrics, sampling=False):
    ...
    if sampling:
        ...
        summary_metric['rou50'] = raw_metrics['rou50'][0] / \
            raw_metrics['rou50'][1]
        summary_metric['rou10'] = raw_metrics['rou10'][0] / \
            raw_metrics['rou10'][1]
